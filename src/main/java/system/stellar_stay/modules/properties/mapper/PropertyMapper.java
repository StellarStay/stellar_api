...
import system.stellar_stay.modules.properties.dto.properties.response.ManagerResponse;
...
public interface PropertyMapper {
    ...
    ListPropertiesResponseForManagerDTO toResponseForManagerDTO(PropertiesEntity propertiesEntity);



    Set<ListPropertiesResponseForManagerDTO> toResponseDTOSet(Set<PropertiesEntity> propertiesEntities);
    ...
    ListPropertiesResponseForAdminDTO toResponseForAdminDTO(PropertiesEntity propertiesEntity);
}
